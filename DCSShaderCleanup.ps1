...
Must be run as administrator as it touches the Program Files directory
which is protected by UAC.

Writen by /u/LOLBaltSS on Reddit, AKA "SpyderF16" in DCSWorld.
